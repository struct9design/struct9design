...
const tycSections: [string, string][] = [
  ...
  ['2. Objeto y ámbito de aplicación', 'Estos Términos y Condiciones regulan la contratación de los servicios de STRUCT9 DESIGN, incluyendo diagnósticos SEO y de marketing digital, diseño y desarrollo web, automatizaciones de procesos, extensiones de Chrome, dashboards financieros y el servicio de mantenimiento mensual (Retainer). La aceptación del presupuesto implica la aceptación íntegra de estas condiciones.'],
  ...
  ['4. Precios y formas de pago', 'El precio final queda reflejado en el presupuesto personalizado enviado al cliente. La contratación se formaliza mediante la aceptación expresa de dicho presupuesto. El pago se realiza mediante efectivo o a través de pasarela de pago segura (Stripe). Para proyectos superiores a 500€: 50% al inicio y 50% a la entrega. Para diagnósticos y servicios express: 100% al inicio. El Retainer mensual se factura por adelantado el primer día de cada periodo. Los presupuestos tienen una validez de 24 horas desde su emisión, salvo indicación contraria expresa en el propio documento. Transcurrido dicho plazo, STRUCT9 se reserva el derecho a revisar las condiciones económicas ofertadas.'],
  ...
  ['10. Cancelaciones y política de devoluciones', 'El cliente puede cancelar el encargo antes del inicio efectivo del trabajo con derecho a reembolso total. Una vez iniciados los trabajos, el pago inicial (50%) no es reembolsable, dado que cubre los recursos ya asignados al proyecto. En servicios de diagnóstico con pago 100% al inicio, no procede devolución una vez entregado el informe. El Retainer mensual puede cancelarse con 15 días naturales de preaviso, respetando el periodo mínimo de 3 meses contratado.'],
